...
This Terraform template deploys on Google Cloud the [IBM Cloud Private](https://www.ibm.com/cloud-computing/products/ibm-cloud-private/) version 3.1.2 in a minimal configuration, using the ICP 3.1.2 CE binaries from Docker Hub. 
...
| `icp_inception_image` | yes | ICP image to use for installation  | ibmcom/icp-inception:3.1.2 |
